...
class LiveStringPreference(prefs: SharedPreferences, key: String, default: String = "") :
    LivePreference<String>(prefs, key, default) {

    override fun getPrefValue(): String = prefs.getString(key, default).toString()

    override fun writePrefValue(value: String) = prefs.edit().putString(key, value).apply()
}

class LiveIntPreference(prefs: SharedPreferences, key: String, default: Int = -1) :
    LivePreference<Int>(prefs, key, default) {

    override fun getPrefValue(): Int = prefs.getInt(key, default)

    override fun writePrefValue(value: Int) = prefs.edit().putInt(key, value).apply()
}